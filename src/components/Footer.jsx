      ...
      <div className="container mx-auto px-6 py-12 grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-3 mb-4">
            <SocialIcon href="https://www.instagram.com/naseemagold/?hl=en">IG</SocialIcon>
            <SocialIcon href="https://www.facebook.com/naseemagoldanddiamonds/">FB</SocialIcon>
          ...
          <form className="flex gap-2">
            ...
            <button className="px-4 py-2 bg-naseema border-1 hover:to-blue-300 text-[#000] rounded">Subscribe</button>
          </form>
        </div>
      </div>
